...
class RedisDatabase {
    ...
    public void set(String key, RedisEntry entry) {
    ...
    public int incr(String key, int value) {
        ...
        intValue += value;
        RedisEntry newEntry =new RedisEntry(RedisType.STRING,String.valueOf(intValue),null);
